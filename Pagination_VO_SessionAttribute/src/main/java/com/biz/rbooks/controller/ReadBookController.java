...
import com.biz.rbooks.domain.util.SearchVO;
...
public class ReadBookController {
	...
	public String showAllList(@ModelAttribute("searchVO") SearchVO searchVO,Model model,@RequestParam(value = "currentPageNo", required = false,
			defaultValue = "1") int currentPageNo) {
		String searchOption=searchVO.getSearchOption();
		String inputStr=searchVO.getInputStr();
