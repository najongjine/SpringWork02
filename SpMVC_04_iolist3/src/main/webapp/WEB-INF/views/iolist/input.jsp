...
label을 클릭했을때 마치 input box를 클릭한거처럼 input box에 focus를 지정 -->
				<input name="io_seq" id="io_seq" value="${IO_DTO.io_seq}" readonly="readonly"
				type="hidden" value="<c:out value='${IO_DTO.io_price }' default='0'/>">
			...
			<div class="in-box">
				<input name="io_total" id="io_total" type="number" value="<c:out value='${IO_DTO.io_total }' default='0'/>">
			</div>
