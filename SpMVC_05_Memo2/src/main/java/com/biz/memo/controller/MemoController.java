 ...
 * 클래스 표준 객체생성 패턴에 의해 만들어진 이름(MemoDTO memoDTO)
 * */
...
public class MemoController {
	 ...
	 * 표준패턴이 아닐경우 @modelattribute("objectname"을 필수로 지정해 주어야한다.
	 * */
	...
	public String insert(@ModelAttribute MemoDTO memoDTO, Model model, String search
		...
		/* SessionAttribute을 사용할때 insert, update가 완료되고
		 * view로 보내기전에 setComplete()을 실행하여 
