...
/*
div box에 img를 2개 가져오고 초기에는 2번째 이미지를 감춰둔다
*/
...
/*
마우스를 div-box에 올리면 처음 이미지는 감추고 두번째 이미지는 보여라
*/
...
$(function() {
	...
	<form method="POST" action="${rootPath }/member/login" class="login-form">
		...
		<div class="naver_login">
			<img src="${rootPath}/resources/img/naver_green.png" width="200px">
			<img src="${rootPath}/resources/img/naver_white.png" width="200px">
		</div>
