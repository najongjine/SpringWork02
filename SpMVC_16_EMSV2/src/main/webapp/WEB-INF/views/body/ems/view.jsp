...
<section>
	<table class="main-list">
		<tr>
			<td>SEQ: </td><td>${emailVO.ems_seq}</td>
		</tr>
		
		<tr>
			<td>보낸이메일: </td><td>${emailVO.from_email}</td>
		</tr>
		...
		<tr>
			<td>보낸분: </td><td>${emailVO.from_name}</td>
		</tr>
		...
		<tr>
			<td>보낸날짜: </td><td>${emailVO.send_date}</td>
		</tr>
		
		<tr>
			<td>보낸시간: </td><td>${emailVO.send_time}</td>
		</tr>
