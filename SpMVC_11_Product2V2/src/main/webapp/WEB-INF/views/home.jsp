...
<body>
	...
	<section class="container-fluid">
		<article class="row d-flex justify-content-center">
			<div id="p_list" class="col-lg-4 col-mg-5 col-sm-11 ">상품리스트
			<%@ include file="/WEB-INF/views/p-list.jsp" %></div>
			<section class="col-lg-4 col-mg-5 col-sm-11">
			
				<form class="was-validated" action="${rootPath }/input" method="post"
				enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<label></label>
						<input type="file" class="form-controller" name="u_file" id="u_file">
					</div>
					
					<div class="form-group">
						<img src="${rootPath }/files/noimage.png" width="200px" id="p_image" >
					</div>
			...
			<div id="p_list" class="col-lg-3 col-mg-5 col-sm-11 ">보조정보</div>
		</article>
	</section>
	<footer class="container-fluid bg-primary">
		<address class="text-center text-white">Copy Right &copy; najongjin3@hotmail.com</address>
	</footer>
</body>
</html>